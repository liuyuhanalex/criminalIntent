...
public class CrimeFragment extends Fragment {
    ...
    private TextView NumberOfFace;
    private CheckBox checkBox;

    private ArrayList<ImageView> imageViews = new ArrayList<ImageView>(4);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NumberOfFace = (TextView) v.findViewById(R.id.NumberOfFace);
        checkBox = (CheckBox) v.findViewById(R.id.checkBox);

        imageViews.add((ImageView) v.findViewById(R.id.crime_photo));
        imageViews.add((ImageView) v.findViewById(R.id.imageView1));
        imageViews.add((ImageView) v.findViewById(R.id.imageView2));
        imageViews.add((ImageView) v.findViewById(R.id.imageView3));
    ...
    private void updatePhotoView() {
        ...
        mPhotoFiles = CrimeLab.get(getActivity()).getAllPhotoFiles(mCrime);
